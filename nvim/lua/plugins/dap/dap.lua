...
return {
  plugins.dap.repo_dap,
  name = plugins.dap.dap,
  dependencies = {
    {
      -- Plugin: https://github.com/theHamsta/nvim-dap-virtual-text
      plugins.dap.repo_dap_virtual_text,
      name = plugins.dap.dap_virtual_text,
      lazy = true,
    },
  },
  -- stylua: ignore
